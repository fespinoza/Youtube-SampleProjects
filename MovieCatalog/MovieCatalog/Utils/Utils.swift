...
enum Utils {
    ...
    static func formattedUpcomingReleaseDate(from dateString: String) -> String {
    ...
    static func formattedReleaseYear(from string: String?) -> String {
        guard
            let string,
    ...
    static func formattedReleaseDate(from string: String?) -> String {
        guard
            let string,
            let date = parseReleaseDate(from: string)
        else {
