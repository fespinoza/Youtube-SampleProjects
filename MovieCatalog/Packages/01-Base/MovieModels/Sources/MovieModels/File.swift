...
//public enum FailableDto<DtoType: PolymorphicDto> {
//    /// Successfully decoded a known DTO
//    case value(DtoType)
//
//    /// Failed to decode a known DTO
//    case failed(type: String, error: Error)
//
//    /// Received an unknown DTO
