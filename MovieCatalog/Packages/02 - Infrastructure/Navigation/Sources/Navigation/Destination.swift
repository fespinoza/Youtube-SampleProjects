...
public enum PushDestination: Sendable, Hashable, CustomStringConvertible {
...
public enum TabDestination: String, Hashable, Sendable {
    case home
    case search
...
public enum SheetDestination: Hashable, CustomStringConvertible, Sendable {
...
public enum FullScreenDestination: Hashable, Sendable {
