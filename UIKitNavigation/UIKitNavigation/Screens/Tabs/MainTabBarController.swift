...
class MainTabBarController: UITabBarController {
    override func viewDidLoad() {
        ...
        firstVC.view.backgroundColor = .systemRed.withAlphaComponent(0.4)
        ...
        secondVC.view.backgroundColor = .systemGreen.withAlphaComponent(0.4)
        ...
        thirdVC.view.backgroundColor = .systemYellow.withAlphaComponent(0.4)
